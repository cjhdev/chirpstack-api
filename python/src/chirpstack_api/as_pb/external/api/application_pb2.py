...
_CREATEMQTTINTEGRATIONCERTIFICATEREQUEST = _descriptor.Descriptor(
  name='CreateMQTTIntegrationCertificateRequest',
  full_name='api.CreateMQTTIntegrationCertificateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='application_id', full_name='api.CreateMQTTIntegrationCertificateRequest.application_id', index=0,
      number=1, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATEMQTTINTEGRATIONCERTIFICATERESPONSE = _descriptor.Descriptor(
  name='CreateMQTTIntegrationCertificateResponse',
  full_name='api.CreateMQTTIntegrationCertificateResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='tls_cert', full_name='api.CreateMQTTIntegrationCertificateResponse.tls_cert', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tls_key', full_name='api.CreateMQTTIntegrationCertificateResponse.tls_key', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ca_cert', full_name='api.CreateMQTTIntegrationCertificateResponse.ca_cert', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='expires_at', full_name='api.CreateMQTTIntegrationCertificateResponse.expires_at', index=3,
...
_CREATEMQTTINTEGRATIONCERTIFICATERESPONSE.fields_by_name['expires_at'].message_type = google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
...
DESCRIPTOR.message_types_by_name['CreateMQTTIntegrationCertificateRequest'] = _CREATEMQTTINTEGRATIONCERTIFICATEREQUEST
DESCRIPTOR.message_types_by_name['CreateMQTTIntegrationCertificateResponse'] = _CREATEMQTTINTEGRATIONCERTIFICATERESPONSE
...
CreateMQTTIntegrationCertificateRequest = _reflection.GeneratedProtocolMessageType('CreateMQTTIntegrationCertificateRequest', (_message.Message,), {
  'DESCRIPTOR' : _CREATEMQTTINTEGRATIONCERTIFICATEREQUEST,
  '__module__' : 'chirpstack_api.as_pb.external.api.application_pb2'
  # @@protoc_insertion_point(class_scope:api.CreateMQTTIntegrationCertificateRequest)
  })
_sym_db.RegisterMessage(CreateMQTTIntegrationCertificateRequest)

CreateMQTTIntegrationCertificateResponse = _reflection.GeneratedProtocolMessageType('CreateMQTTIntegrationCertificateResponse', (_message.Message,), {
  'DESCRIPTOR' : _CREATEMQTTINTEGRATIONCERTIFICATERESPONSE,
  '__module__' : 'chirpstack_api.as_pb.external.api.application_pb2'
  # @@protoc_insertion_point(class_scope:api.CreateMQTTIntegrationCertificateResponse)
  })
_sym_db.RegisterMessage(CreateMQTTIntegrationCertificateResponse)
...
_APPLICATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CreateMQTTIntegrationCertificate',
    full_name='api.ApplicationService.CreateMQTTIntegrationCertificate',
    index=42,
    containing_service=None,
    input_type=_CREATEMQTTINTEGRATIONCERTIFICATEREQUEST,
    output_type=_CREATEMQTTINTEGRATIONCERTIFICATERESPONSE,
